...
```{r  iFlpscLineage per Arrays, fig.height= 7, fig.width=7, echo=FALSE}

GEA_Partial_recomb_clones <- readRDS("../rds/GEA_Founders_clones_processed_Nanopore.rds")

conditions <- levels(GEA_Partial_recomb_clones@meta.data$Condition)
...
```{r scRNASeq, fig.height= 20, fig.width=30}
...
```{r Upset, fig.height= 10, fig.width=20}
...
```{r Venn Clones Founders, fig.height= 10, fig.width=15}
...
```{r Clones Venn, fig.height= 60, fig.width=120}
...
```{r Venn Target FRT-BCs, fig.height= 30, fig.width=15}
...
```{r FeaturePlots Clones, fig.height= 30, fig.width=15}
...
```{r BCs Freq pathmatrix, fig.height=10, fig.width=25, echo=FALSE}
...
```{r  BCs table for Irepan 2, fig.height=20, fig.width=10, echo=FALSE}
...
```{r  Plot unique BCs, fig.height=20, fig.width=30, echo=FALSE}
